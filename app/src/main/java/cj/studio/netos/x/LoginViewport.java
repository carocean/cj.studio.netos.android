...
import cj.studio.netos.framework.LoginFrom;
 ...
 */
@Viewport(name = "/login")
public class LoginViewport extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    @ServiceSite
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.viewport_login);
...
//        return password.length() > 4;
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(LoginViewport.this,
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                String[] addresslist=new String[]{"tcp://192.168.1.101:7002"};
