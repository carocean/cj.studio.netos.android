...
class DesktopPopupAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    ...
    DesktopPopupAdapter(Context context, List<CustomItem> mItems, int orientation) {
        ...
        padding = context.getResources().getDimensionPixelSize(com.pedaily.yc.ycdialoglib.R.dimen.app_normal_margin);
        topPadding = context.getResources().getDimensionPixelSize(com.pedaily.yc.ycdialoglib.R.dimen.app_tiny_margin);
        leftPadding = context.getResources().getDimensionPixelSize(com.pedaily.yc.ycdialoglib.R.dimen.app_normal_margin);
        topIcon = context.getResources().getDimensionPixelSize(com.pedaily.yc.ycdialoglib.R.dimen.bottom_dialog_top_icon);
        leftIcon = context.getResources().getDimensionPixelSize(com.pedaily.yc.ycdialoglib.R.dimen.bottom_dialog_left_icon);
    }
    ...
    private class TopHolder extends RecyclerView.ViewHolder {
        ...
        TopHolder(View view) {
            ...
            item.setTextColor(ContextCompat.getColor(view.getContext(), com.pedaily.yc.ycdialoglib.R.color.gray_dark));
            item.setTextSize(TypedValue.COMPLEX_UNIT_PX, context.getResources().getDimension(com.pedaily.yc.ycdialoglib.R.dimen.app_normal_margin));
    ...
    private class LeftHolder extends RecyclerView.ViewHolder {
        ...
        LeftHolder(View view) {
            ...
            item.setTextColor(ContextCompat.getColor(view.getContext(), com.pedaily.yc.ycdialoglib.R.color.gray_black));
            item.setTextSize(TypedValue.COMPLEX_UNIT_PX, context.getResources().getDimension(com.pedaily.yc.ycdialoglib.R.dimen.app_normal_margin));
